...
export function WhatsAppFloat() {
  ...
  return (
    // Çerez bandı açıkken (body.consent-open) bandın üstüne çık — aksi hâlde
    // bant butonu örtüyor (16.09.2026 ölçümü).
    <a
      href={buildWhatsAppUrlForPath(locale, pathname)}
      target="_blank"
      rel="noopener"
      aria-label="WhatsApp"
      className="fixed bottom-5 right-5 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-2xl transition-all hover:scale-110 [.consent-open_&]:bottom-28"
    >
