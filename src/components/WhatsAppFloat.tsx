...
export function WhatsAppFloat() {
  ...
  return (
    ...
    <a
      ...
      rel="noopener"
      aria-label="WhatsApp"
      className="fixed bottom-5 right-5 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-2xl transition-all hover:scale-110 [.consent-open_&]:bottom-36"
    >
